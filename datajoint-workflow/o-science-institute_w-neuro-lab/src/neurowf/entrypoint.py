...
script will run the [`run()`][neurowf.entrypoint.run] function in this module and
requires content from the `neurowf` package.
...
Example:
    ...
    Usage from python:
        ...
        from neurowf import run; run(task='task1', duration=20, sleep=5)
...
def run(**kwargs: Any) -> None:
    ...
    See [Example][neurowf.entrypoint] for a list of args.
    """
...
def cli() -> None:
    """_Calls [`entrypoint.run`][neurowf.entrypoint.run], passing the cli
